    ...
    <div class="hamburger_wrapper">
        <div class="hamburger_inner">
            <div class="hamburger_top d-flex align-items-center justify-content-between">
                <div class="hamburger_logo">
                    <a href="index.php" class="mobile_logo">
                        <img src="assets/images/logos/ll.png" alt="NXT Level Limited">
                    </a>
                </div>
            ...
            <div class="offcanvas-text">
                <p class="text-white"> <strong> NXT Level </strong> — Delivering Back-office Support , Shared
                    Services, Staff Augmentation and
                    Business Consultancy from New Zealand to the world.</p>
            </div>
            ...
            <div class="hamburger-infos">
                ...
                <div class="contact-info">
                    ...
                    <div class="contact-item">
                        <a href="tel:+64204504050">
                            <span class="icon"><i class="fa-solid fa-phone"></i></span>
                            <span class="text">+64 20 450 4050</span>
                        </a><br>

                        <a href="mailto:info@nxtlevel.nz">
                            <span class="icon"><i class="fa-solid fa-envelope"></i></span>
                            <span class="text">info@nxtlevel.nz</span>
                        </a>
                    </div>

                    <!-- Head Office (New Zealand) -->
                    <div class="contact-item">
                        <span class="subtitle"><strong>Head Office (NZ)</strong></span>
                    ...
                    <!-- <div class="contact-item">
                          <span class="subtitle"> <strong>India — Ahmedabad</strong></span>
                          <div class="contact-link">
                              Prahlad Nagar Trade Center, Satalite,<br>
                    ...
                    <!-- India Address 2 -->
                    <!-- <div class="contact-item">
                          <span class="subtitle"><strong> India — Nashik </strong></span>
                          <div class="contact-link">
                              Vedant Plaza,
                              Tidke Colony,<br>
        ...
        <div class="hamburger-socials">
            ...
            <div class="social-links style-3">
                <ul>
                    <li><a href="https://www.facebook.com/share/1DcmbJCQ1b/?mibextid=wwXIfr" target="_blank"><i
                                class="fa-brands fa-facebook-f"></i></a></li>
                    <li><a href="https://www.instagram.com/nxtlevel.nz" target="_blank"><i
                                class="fa-brands fa-instagram"></i></a></li>
                    <!-- <li><a href="https://x.com/" target="_blank"><i class="fa-brands fa-x-twitter"></i></a></li> -->
                    <li><a href=" https://www.linkedin.com/company/nxtlevel-limited/" target="_blank"><i
        ...
        <div class="hamburger-socials">
            ...
            <div class="social-links style-3">
                <ul>
                    <li><a href="https://www.facebook.com/share/1DcmbJCQ1b/?mibextid=wwXIfr" target="_blank"><i
                                class="fa-brands fa-facebook-f"></i></a></li>
                    <li><a href="https://www.instagram.com/NXT Level.nz" target="_blank"><i
                                class="fa-brands fa-instagram"></i></a></li>
                    <!-- <li><a href="https://x.com/" target="_blank"><i class="fa-brands fa-x-twitter"></i></a></li> -->
                    <li><a href=" https://www.linkedin.com/company/NXT Level-limited/" target="_blank"><i
                                class="fa-brands fa-linkedin-in"></i></a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12 px-0">
                <div class="header-wrapper">
                    <!-- site logo -->
                    <div class="site_logo">
                        <a class="logo" href="/"><img src="assets/images/logos/ll.png" alt=""></a>
                    </div>
